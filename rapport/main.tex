...
Ce TP nous a permis d'explorer concrètement les différentes approches de lissage de maillages 3D, depuis les méthodes les plus intuitives jusqu'à des méthodes plus élaborées.
L'utilisation de CGAL et de sa structure en demi-arêtes s'est avérée particulièrement adaptée à ce type de travail, en rendant le parcours topologique du voisinage de chaque sommet
à la fois simple et efficace.

Il n'existe pas de méthode universellement meilleure, chaque algorithme présente des compromis entre facilité d'implémentation, qualité du lissage
et préservation de la géométrie originelle. Le lissage laplacien simple est immédiat à mettre en œuvre mais destructeur sur le long terme. Le facteur de diffusion apporte un premier contrôle
sans résoudre le problème de fond. La méthode de Taubin constitue une réponse efficace au phénomène de rétrécissement, tandis que la pondération par cotangentes illustre
l'importance d'adapter la méthode à la nature de la géométrie du maillage traité.
